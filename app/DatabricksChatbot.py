...
class DatabricksChatbot:
    ...
    def _create_layout(self):
        return html.Div([
            ...
            html.Div([
                html.H2('Chat with Databricks AI', className='chat-title mb-3'),
                html.Div([
                    html.Label('Model Endpoint Name:', htmlFor='model-name', style={'fontWeight': '500', 'fontSize': '14px', 'marginRight': '10px', 'whiteSpace': 'nowrap', 'alignSelf': 'center'}),
                    dbc.Input(
                                id='model-name',
                                type='text',
    ...
    def _create_callbacks(self):
        ...
        def process_assistant_response(trigger, chat_history, model):
            ...
            self.endpoint_name = model
            try:
                print('_call_model_endpoint:', self.endpoint_name)
    ...
    def _call_model_endpoint(self, messages, max_tokens=1000):
        try:
