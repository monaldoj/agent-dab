...
# This example would add all of the UC Functions in your_catalog.your_schema as tools for the agent
...
# This example would add the vector search index your_catalog.your_schema.your_index as a tool for the agent
